...
- **Zero runtime risk for this skill** — `blueprint` itself is pure Markdown. It does not ship hooks, shell scripts, or executable helpers; activation only loads the instructions in this file.
